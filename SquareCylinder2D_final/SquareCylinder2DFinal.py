...
with CodeGeneration() as ctx:
    ...
    lbm_config = LBMConfig(
        ...
        compressible=True,
        # subgrid_scale_model=SubgridScaleModel.SMAGORINSKY,  # disabled: iLES via K17 only
    ...
    generate_lbm_package(ctx, name="SquareCylinder2DFinal", collision_rule=collision_rule,
    ...
    generate_info_header(ctx, 'SquareCylinder2DFinalInfoHeader',
    ...
    ctx.write_file("SquareCylinder2DFinalStaticDefines.h", info_header.format(**infoHeaderParams))
